...
## [v0.0.5](https://github.com/miscord-dev/tetrapod/compare/v0.0.4...v0.0.5) - 2026-08-31
...
- Update golang Docker tag to v1.26 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/176
- Update kubernetes packages to v0.35.2 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/177
- Update module github.com/containernetworking/plugins to v1.9.0 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/178
- Update module github.com/mdlayher/netlink to v1.9.0 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/179
- Update module github.com/onsi/ginkgo/v2 to v2.28.1 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/180
- Update module github.com/onsi/gomega to v1.39.1 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/181
- Update module golang.org/x/crypto to v0.48.0 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/182
- Update module golang.org/x/net to v0.51.0 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/183
- Update module golang.org/x/sync to v0.19.0 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/184
- Update module golang.org/x/sys to v0.41.0 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/185
- Update module sigs.k8s.io/controller-runtime to v0.23.1 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/186
- Update module sigs.k8s.io/controller-runtime to v0.23.3 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/190
- Update module github.com/cilium/ebpf to v0.21.0 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/191
- Update debian Docker tag to bullseye-20260406 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/194
- Update kubernetes monorepo to v0.35.3 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/195
- Update module github.com/containernetworking/plugins to v1.9.1 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/196
- Update module github.com/mdlayher/netlink to v1.11.0 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/197
- Update module golang.org/x/crypto to v0.50.0 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/198
- Update module golang.org/x/net to v0.53.0 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/199
- Update module golang.org/x/sync to v0.20.0 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/200
- Update module golang.org/x/sys to v0.43.0 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/201
- Update kubernetes monorepo to v0.35.4 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/203
- Update debian Docker tag to bullseye-20260610 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/204
- Update module github.com/mdlayher/netlink to v1.11.2 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/205
- Update kubernetes monorepo to v0.36.2 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/206
- Update module github.com/onsi/ginkgo/v2 to v2.31.0 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/207
- Update module github.com/onsi/gomega to v1.42.0 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/208
- Update module go.uber.org/zap to v1.28.0 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/209
- Update module golang.org/x/crypto to v0.53.0 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/210
- Update module golang.org/x/net to v0.56.0 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/211
- Update module golang.org/x/sync to v0.21.0 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/212
- Update module golang.org/x/sys to v0.46.0 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/213
- Update module sigs.k8s.io/controller-runtime to v0.24.1 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/214
- Update debian Docker tag to bullseye-20260623 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/216
- Update module github.com/onsi/gomega to v1.42.1 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/217
- Update debian Docker tag to bullseye-20260713 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/218
- Update module github.com/cilium/ebpf to v0.22.0 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/219
- Update module github.com/onsi/ginkgo/v2 to v2.32.0 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/220
- Update module golang.org/x/crypto to v0.54.0 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/221
- Update module golang.org/x/net to v0.57.0 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/222
- Update module golang.org/x/sync to v0.22.0 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/223
- Update module golang.org/x/sys to v0.47.0 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/224
- Update module github.com/onsi/ginkgo/v2 to v2.32.1 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/226
- Update golang Docker tag to v1.27 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/227
- Update kubernetes monorepo to v0.37.0 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/228
- Update module github.com/onsi/gomega to v1.43.0 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/229
- Update module github.com/seancfoley/ipaddress-go to v1.8.3 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/230
- Update module golang.org/x/crypto to v0.55.0 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/231
- Update module golang.org/x/net to v0.58.0 by @renovate[bot] in https://github.com/miscord-dev/tetrapod/pull/232
