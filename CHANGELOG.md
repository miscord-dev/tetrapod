...
## [v0.0.5](https://github.com/miscord-dev/tetrapod/compare/v0.0.4...v0.0.5) - 2024-08-13
...
- Update kubernetes packages to v0.30.3 by @renovate in https://github.com/miscord-dev/tetrapod/pull/128
- Update module github.com/containernetworking/cni to v1.2.3 by @renovate in https://github.com/miscord-dev/tetrapod/pull/129
- Update module sigs.k8s.io/controller-runtime to v0.18.5 by @renovate in https://github.com/miscord-dev/tetrapod/pull/130
- Update module github.com/cilium/ebpf to v0.16.0 by @renovate in https://github.com/miscord-dev/tetrapod/pull/131
- Update module github.com/containernetworking/plugins to v1.5.1 by @renovate in https://github.com/miscord-dev/tetrapod/pull/132
- Update module github.com/onsi/ginkgo/v2 to v2.20.0 by @renovate in https://github.com/miscord-dev/tetrapod/pull/133
- Update module github.com/onsi/gomega to v1.34.1 by @renovate in https://github.com/miscord-dev/tetrapod/pull/134
- Update module github.com/seancfoley/ipaddress-go to v1.6.0 by @renovate in https://github.com/miscord-dev/tetrapod/pull/135
- Update module golang.org/x/crypto to v0.26.0 by @renovate in https://github.com/miscord-dev/tetrapod/pull/136
- Update module golang.org/x/net to v0.28.0 by @renovate in https://github.com/miscord-dev/tetrapod/pull/137
- Update kubernetes packages to v0.31.0 by @renovate in https://github.com/miscord-dev/tetrapod/pull/138
- Update module golang.org/x/sync to v0.8.0 by @renovate in https://github.com/miscord-dev/tetrapod/pull/139
- Update golang Docker tag to v1.23 by @renovate in https://github.com/miscord-dev/tetrapod/pull/140
- Update module golang.org/x/sys to v0.24.0 by @renovate in https://github.com/miscord-dev/tetrapod/pull/141
