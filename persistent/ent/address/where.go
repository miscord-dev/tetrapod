...
func Addr(v string) predicate.Address {
	return predicate.Address(func(s *sql.Selector) {
...
func AddrEQ(v string) predicate.Address {
	return predicate.Address(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldAddr), v))
	})
}
...
func AddrNEQ(v string) predicate.Address {
	return predicate.Address(func(s *sql.Selector) {
...
func AddrIn(vs ...string) predicate.Address {
...
func AddrNotIn(vs ...string) predicate.Address {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func AddrGT(v string) predicate.Address {
	return predicate.Address(func(s *sql.Selector) {
...
func AddrGTE(v string) predicate.Address {
	return predicate.Address(func(s *sql.Selector) {
...
func AddrLT(v string) predicate.Address {
	return predicate.Address(func(s *sql.Selector) {
...
func AddrLTE(v string) predicate.Address {
	return predicate.Address(func(s *sql.Selector) {
...
func AddrContains(v string) predicate.Address {
	return predicate.Address(func(s *sql.Selector) {
...
func AddrHasPrefix(v string) predicate.Address {
	return predicate.Address(func(s *sql.Selector) {
...
func AddrHasSuffix(v string) predicate.Address {
	return predicate.Address(func(s *sql.Selector) {
...
func AddrEqualFold(v string) predicate.Address {
	return predicate.Address(func(s *sql.Selector) {
...
func AddrContainsFold(v string) predicate.Address {
	return predicate.Address(func(s *sql.Selector) {
...
func HasHost() predicate.Address {
	return predicate.Address(func(s *sql.Selector) {
...
func HasHostWith(preds ...predicate.Node) predicate.Address {
	return predicate.Address(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
