...
func (in *PeerNodeStatus) DeepCopyInto(out *PeerNodeStatus) {
	*out = *in
	if in.CIDRClaims != nil {
		in, out := &in.CIDRClaims, &out.CIDRClaims
		*out = make([]PeerNodeStatusCIDRClaim, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PeerNodeStatusCIDRClaim) DeepCopyInto(out *PeerNodeStatusCIDRClaim) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PeerNodeStatusCIDRClaim.
func (in *PeerNodeStatusCIDRClaim) DeepCopy() *PeerNodeStatusCIDRClaim {
	if in == nil {
		return nil
	}
	out := new(PeerNodeStatusCIDRClaim)
	in.DeepCopyInto(out)
	return out
}
